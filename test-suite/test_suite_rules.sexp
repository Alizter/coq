...
(subdir complexity
 ...
 (rule
  ...
  (deps ring2.vo
        ../tools/complexity.sh)
  (action
   (setenv BOGOMIPS 4599 (run ../tools/complexity.sh ring2.v ring2.v.log))))
 (rule
  (alias runtest)
  (deps bug4076bis.vo
        ../tools/complexity.sh)
 ...
 (rule
  ...
  (deps guard.vo
        ../tools/complexity.sh)
  (action
   (setenv BOGOMIPS 4599 (run ../tools/complexity.sh guard.v guard.v.log))))
 (rule
  (alias runtest)
 ...
 (rule
  ...
  (deps ring.vo
        ../tools/complexity.sh)
  (action
   (setenv BOGOMIPS 4599 (run ../tools/complexity.sh ring.v ring.v.log))))
 (rule
  (alias runtest)
  (deps bug_13227_6.vo
        ../tools/complexity.sh)
